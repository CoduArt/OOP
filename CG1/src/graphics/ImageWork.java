...
public class ImageWork  {
    private static final Image CARD_SHIRT_IMAGE = new ImageIcon("src/graphics/CardsPack/Shirt.png").getImage();
    private static final Image STAND_IMAGE = new ImageIcon("src/graphics/CardsPack/CardsWithGreen2.jpg").getImage();
    private static final Image CHIP_IMAGE = new ImageIcon("src/graphics/CardsPack/chip3.png").getImage();
